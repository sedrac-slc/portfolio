...
import TextEnterprise from '@/components/TextEnterprise.vue';
...
<template>
      <section class="flex flex-col md:flex-row items-center w-full gap-2 md:gap-10">
        <div class="w-3/5 rounded-2xl p-6 pt-0 flex flex-col gap-2 items-center justify-center">
          ...
          <div class="mt-3 md:mt-6 text-lg md:indent-10 text-center">
            ...
            freelancer de forma profissional criando software para web, mobile e desktop com diversas linguagens e frameworks.
          </div>
          <SocialMedia />
        </div>
        <div>
      ...
      <section class="flex flex-col md:flex-row w-full gap-2 md:gap-10">
        <div class="bg-white rounded-xl p-3 w-4/12">
          <div class="mb-5 font-semibold text-gray-500 text-lg">Linguagens de programação</div>
          <div class="space-y-3">
            <TextProgress text="PHP" :percetage="90" class-indicator="bg-blue-300" />
            <TextProgress text="Javascript" :percetage="85" class-indicator="bg-blue-300" />
            <TextProgress text="Dart" :percetage="80" class-indicator="bg-blue-300" />
            <TextProgress text="Java" :percetage="70" class-indicator="bg-blue-300" />
            <TextProgress text="Kotlin" :percetage="40" class-indicator="bg-blue-300" />
            <TextProgress text="Python" :percetage="20" class-indicator="bg-blue-300" />
          </div>
        </div>
        <div class="bg-white rounded-xl p-3 w-4/12">
          ...
          <div class="space-y-3">
            ...
            <TextProgress text="Next.js" :percetage="73" class-indicator="bg-green-300" :img="Base64Img.NEXT"/>
            <TextProgress text="Spring boot" :percetage="80" class-indicator="bg-green-300" :img="Base64Img.SPRING_BOOT"/>
            <TextProgress text="Nuxt.js" :percetage="70" class-indicator="bg-green-300" :img="Base64Img.NUXT"/>
            <TextProgress text="React Native" :percetage="75" class-indicator="bg-green-300" :img="Base64Img.REACT_NATIVE"/>
        ...
        <div class="bg-white rounded-xl p-3 w-4/12">
          ...
          <TextEnterprise text="Reitoria da Universidade Katyvala Bwila" :period="6" role="Técnico de TI (Estagio)"
            desc="meses" />
          <TextEnterprise text="Grupo Queiros Saldanha" :period="2" role="Desenvolvedor Software (Efectivo)"
            desc="anos" />
